 ...
 <body>
	...
	<section>
		...
		<h3 class="register-title"> Create an account </h3>
			...
			<input type="text" name="mname" placeholder="Enter Initial of Your Middle name : " />
			<input type="text" name="lname" placeholder="Enter Your Last name : " />
			<input type="text" name="mobile" placeholder="Enter Your Mobile Number : " />
			<input type="text" name="date" placeholder="Enter Your Date of Joining : " />
			<input type="text" name="adhar" placeholder="Enter Your Aadhar Card Number : " />
			<input type="text" name="pp" placeholder="Enter Your Passport Number : " />
			<input type="text" name="license" placeholder="Enter Your Driving License Number : " />
			<input type="text" name="vehicle" placeholder="Enter Your Vehicle Number Plate: " />
        ...
        <?php 
            if(isset($_POST['submit'])){
                ...
                if(preg_match('/^[0-9]{10}+$/', $mobile)) {
                    if(preg_match('^[2-9]{1}[0-9]{3}\\s[0-9]{4}\\s[0-9]{4}$', $adhar)) {
                        if(preg_match('^(([A-Z]{2}[0-9]{2})( )|([A-Z]{2}-[0-9]{2}))((19|20)[0-9][0-9])[0-9]{7}$', $license)) {
